"""
Copyright: https://github.com/ahupp/python-magic
This library is included by cozy due to different packages with the same name (magic) being available 
across distros. This is messy but because the whole situation is messy it seems like the best solution for now.
